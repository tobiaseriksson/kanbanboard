...
{		
	...
	this.date		= d.getDate();
	this.day		= translateToStartOfWeekMonday( d.getDay() );
	...
	d.setDate(1);
	this.firstDay = translateToStartOfWeekMonday( d.getDay() );
...
// Translate 0 = Sunday into 6, i.e. 1 = Monday => 0, 2 = Tueaday => 1, ... 6 = Saturday => 5
function translateToStartOfWeekMonday( day ) {
	var newday = 0;
	switch( day ) {
		case 0:
			newday = 6;
